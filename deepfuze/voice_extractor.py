...
from deepfuze.typing import ModelSet, AudioChunk, Audio
...
def get_voice_extractor() -> Any:
	...
	with thread_lock():
		...
		if VOICE_EXTRACTOR is None:
			...
			VOICE_EXTRACTOR = onnxruntime.InferenceSession(model_path, providers = apply_execution_provider_options(deepfuze.globals.execution_device_id, deepfuze.globals.execution_providers))
